import{$a as O,Aa as T,G as C,I as n,L as b,M as S,N as k,R as m,S as p,T as F,U as D,Ua as N,V as h,W as g,Wa as R,X as v,Y as r,Ya as L,Z as i,Za as E,_a as P,ba as c,bb as z,ca as _,da as I,fb as d,ka as M,ma as o,na as y,oa as l,p as x,q as w,r as f,ra as A}from"./chunk-LYX4EPL3.js";var $=["*"];var G=new w("MAT_CARD_CONFIG"),B=(()=>{class e{appearance;constructor(){let t=f(G,{optional:!0});this.appearance=t?.appearance||"raised"}static \u0275fac=function(s){return new(s||e)};static \u0275cmp=b({type:e,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(s,u){s&2&&M("mat-mdc-card-outlined",u.appearance==="outlined")("mdc-card--outlined",u.appearance==="outlined")("mat-mdc-card-filled",u.appearance==="filled")("mdc-card--filled",u.appearance==="filled")},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:$,decls:1,vars:0,template:function(s,u){s&1&&(_(),I(0))},styles:[`.mat-mdc-card {
  display: flex;
