import{$a as O,Aa as T,G as C,I as n,L as b,M as S,N as k,R as m,S as p,T as F,U as D,Ua as N,V as h,W as g,Wa as R,X as v,Y as r,Ya as L,Z as i,Za as E,_a as P,ba as c,bb as z,ca as _,da as I,fb as d,ka as M,ma as o,na as y,oa as l,p as x,q as w,r as f,ra as A}from"./chunk-GYKEZAX2.js";var $=["*"];var G=new w("MAT_CARD_CONFIG"),j=(()=>{class e{appearance;constructor(){let t=f(G,{optional:!0});this.appearance=t?.appearance||"raised"}static \u0275fac=function(s){return new(s||e)};static \u0275cmp=b({type:e,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(s,u){s&2&&M("mat-mdc-card-outlined",u.appearance==="outlined")("mdc-card--outlined",u.appearance==="outlined")("mat-mdc-card-filled",u.appearance==="filled")("mdc-card--filled",u.appearance==="filled")},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:$,decls:1,vars:0,template:function(s,u){s&1&&(_(),I(0))},styles:[`.mat-mdc-card {
  display: flex;
...
bun run lint
bun run test
bun run build`,links:[{label:"Browse the repository",href:d.links.repository,external:!0}]}]},database:{eyebrow:"Development",title:"Deterministic database generation",lead:"Release builds generate SQLite from the checked-in UTF-16LE TSV files.",sections:[{title:"Build and validate",paragraphs:["Headers, row structure, numeric values and canonical identifiers are checked against fifatables before raw tables, canonical indexes and the FTS5 player-search index are generated. Published range and relationship anomalies remain visible as advisory warnings for modified databases. Integrity, foreign-key, ANALYZE and VACUUM checks finish the build."],code:`bun run db:build
bun run db:validate`},{title:"Read-only runtime",paragraphs:["Electron opens searchable SQLite files read-only. Search values are parameterized, sort and table choices are constrained in code, and the renderer reaches the main-process query and import services only through the typed, sandboxed preload API."]},{title:"Desktop imports",paragraphs:["The desktop application reuses the same validation and normalized database builder for user-selected text folders and decoded PC t3db sources. Import and validation run outside the renderer and write only to an isolated temporary output before installation."],links:[{label:"Custom database user guide",href:"/databases-and-settings"}]}]},licensing:{eyebrow:"Legal",title:"Licensing and data",lead:"Application code and the three FIFA helper libraries are MIT licensed.",sections:[{title:"Application license",paragraphs:["The QDB Finder source code is available under the MIT License. Contributions are accepted under the repository\u2019s contribution and conduct policies."],links:[{label:"Read the MIT License",href:d.links.license,external:!0}]},{title:"Data redistribution",paragraphs:["Redistributors remain responsible for confirming that supplied FIFA game database content may legally be shipped in their jurisdiction."]}]},releases:{eyebrow:"Distribution",title:"GitHub Releases",lead:"Version tags create reproducible Windows x64 artifacts and static documentation.",sections:[{title:"Release flow",paragraphs:["A matching v* tag validates the project on Ubuntu, rebuilds and verifies the SQLite-backed release natively on Windows, publishes checksummed Squirrel and ZIP artifacts, and deploys this prerendered documentation from Ubuntu for non-beta tags.",`This documentation build identifies itself as ${d.versionLabel} and links to the immutable source tag used to produce it.`],links:[{label:`Source for ${d.versionLabel}`,href:d.links.version,external:!0},{label:"Latest download",href:d.links.latestRelease,external:!0},{label:"Changelog",href:d.links.changelog,external:!0}]}]}};var X=(e,a)=>a.title,Z=(e,a)=>a.href;function Y(e,a){if(e&1&&(r(0,"p",6),o(1),i()),e&2){let t=a.$implicit;n(),y(t)}}function J(e,a){if(e&1&&(r(0,"li"),o(1),i()),e&2){let t=a.$implicit;n(),y(t)}}function K(e,a){if(e&1&&(r(0,"ul",7),h(1,J,2,1,"li",null,D),i()),e&2){let t=c().$implicit;n(),g(t.items)}}function ee(e,a){if(e&1&&(r(0,"mat-card",8)(1,"mat-card-content")(2,"mat-icon"),o(3,"info"),i(),r(4,"p",11)(5,"strong"),o(6,"Note:"),i(),o(7),i()()()),e&2){let t=c().$implicit;n(7),l(" ",t.note)}}function te(e,a){if(e&1&&(r(0,"mat-card",9)(1,"mat-card-content")(2,"pre",12)(3,"code"),o(4),i()()()()),e&2){let t=c().$implicit;n(4),y(t.code)}}function ae(e,a){if(e&1&&(r(0,"a",13),o(1),r(2,"mat-icon",15),o(3,"open_in_new"),i()()),e&2){let t=c().$implicit;v("href",t.href,C),n(),l(" ",t.label," ")}}function ne(e,a){if(e&1&&(r(0,"a",14),o(1),r(2,"mat-icon",15),o(3,"arrow_forward"),i()()),e&2){let t=c().$implicit;v("routerLink",t.href),n(),l(" ",t.label," ")}}function ie(e,a){if(e&1&&m(0,ae,4,2,"a",13)(1,ne,4,2,"a",14),e&2){let t=a.$implicit;p(t.external?0:1)}}function re(e,a){if(e&1&&(r(0,"div",10),h(1,ie,2,1,null,null,Z),i()),e&2){let t=c().$implicit;n(),g(t.links)}}function oe(e,a){if(e&1&&(r(0,"section",4)(1,"h2",5),o(2),i(),h(3,Y,2,1,"p",6,F),m(5,K,3,0,"ul",7),m(6,ee,8,1,"mat-card",8),m(7,te,5,1,"mat-card",9),m(8,re,3,0,"div",10),i()),e&2){let t=a.$implicit;n(2),l(" ",t.title," "),n(),g(t.paragraphs),n(2),p(t.items?5:-1),n(),p(t.note?6:-1),n(),p(t.code?7:-1),n(),p(t.links?8:-1)}}var V=class e{route=f(O);data=T(this.route.data,{initialValue:this.route.snapshot.data});page=A(()=>U[String(this.data().slug??"overview")]);static \u0275fac=function(t){return new(t||e)};static \u0275cmp=b({type:e,selectors:[["app-home"]],decls:9,vars:3,consts:[[1,"pb-4","text-base"],[1,"mt-0","text-xs","leading-4","font-bold","tracking-section","text-primary","uppercase"],[1,"mt-2.5","mb-4","max-w-190","text-docs-title","leading-title","font-bold","tracking-title","text-balance"],[1,"mb-12","max-w-175","text-lead","leading-lead","text-pretty","text-docs-copy-muted","max-mobile:mb-9"],[1,"my-10","max-mobile:my-8"],[1,"mb-3","text-docs-heading","leading-tight","font-bold","tracking-tight","text-balance"],[1,"max-w-175","leading-docs-copy","text-pretty","text-docs-copy"],[1,"grid","max-w-175","gap-brand-gap","pl-5","leading-docs-list","text-docs-copy","marker:text-primary"],["appearance","outlined","role","note",1,"mt-5","border-outline-variant","bg-surface-container-lowest"],["appearance","outlined","data-code-card","",1,"mt-5","overflow-hidden","border-outline-variant","bg-surface-container-lowest"],[1,"mt-5","flex","flex-wrap","gap-brand-gap"],[1,"m-0","leading-lead","text-docs-note"],[1,"m-0","overflow-auto","p-5","font-mono","text-sm","leading-lead","text-on-surface"],["mat-stroked-button","",1,"text-primary",3,"href"],["mat-stroked-button","",1,"text-primary",3,"routerLink"],[1,"ml-1"]],template:function(t,s){t&1&&(r(0,"article",0)(1,"p",1),o(2),i(),r(3,"h1",2),o(4),i(),r(5,"p",3),o(6),i(),h(7,oe,9,5,"section",4,X),i()),t&2&&(n(2),l(" ",s.page().eyebrow," "),n(2),l(" ",s.page().title," "),n(2),l(" ",s.page().lead," "),n(),g(s.page().sections))},dependencies:[L,R,H,j,B,P,E,z],styles:["[data-code-card][_ngcontent-%COMP%]   mat-card-content[_ngcontent-%COMP%]{padding:0}mat-card[role=note][_ngcontent-%COMP%]   mat-card-content[_ngcontent-%COMP%]{display:flex;align-items:flex-start;gap:.75rem;padding:1rem}mat-card[role=note][_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{flex:0 0 auto;color:var(--%NS%qdb-brand)}"]})};export{V as Home};
