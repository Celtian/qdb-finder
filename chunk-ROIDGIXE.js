import{Aa as P,Ea as O,G as C,I as n,L as b,M as _,N as k,R as m,S as p,T as M,U as F,V as h,W as g,X as y,Y as r,Z as i,_a as R,ab as L,ba as c,ca as D,cb as E,da as I,db as z,eb as B,fb as d,ka as A,ma as o,na as l,oa as v,p as x,q as w,r as f,ra as S,ya as T}from"./chunk-J3K2UY4V.js";var N=["*"];var G=new w("MAT_CARD_CONFIG"),j=(()=>{class e{appearance;constructor(){let t=f(G,{optional:!0});this.appearance=t?.appearance||"raised"}static \u0275fac=function(s){return new(s||e)};static \u0275cmp=b({type:e,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(s,u){s&2&&A("mat-mdc-card-outlined",u.appearance==="outlined")("mdc-card--outlined",u.appearance==="outlined")("mat-mdc-card-filled",u.appearance==="filled")("mdc-card--filled",u.appearance==="filled")},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:N,decls:1,vars:0,template:function(s,u){s&1&&(D(),I(0))},styles:[`.mat-mdc-card {
  display: flex;
