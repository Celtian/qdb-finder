import{$ as D,$a as d,D as C,F as n,I as b,J as _,K as k,O as m,P as p,Q as M,R as F,S as h,T as g,U as v,V as r,Va as R,W as i,Xa as L,Ya as E,Za as z,_ as c,_a as q,aa as I,ha as A,ja as o,ka as l,la as y,o as x,oa as S,p as w,q as f,ta as T,va as P,za as O}from"./chunk-BLZBD6E6.js";var N=["*"];var G=new w("MAT_CARD_CONFIG"),j=(()=>{class e{appearance;constructor(){let t=f(G,{optional:!0});this.appearance=t?.appearance||"raised"}static \u0275fac=function(s){return new(s||e)};static \u0275cmp=b({type:e,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(s,u){s&2&&A("mat-mdc-card-outlined",u.appearance==="outlined")("mdc-card--outlined",u.appearance==="outlined")("mat-mdc-card-filled",u.appearance==="filled")("mdc-card--filled",u.appearance==="filled")},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:N,decls:1,vars:0,template:function(s,u){s&1&&(D(),I(0))},styles:[`.mat-mdc-card {
  display: flex;
